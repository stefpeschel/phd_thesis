...
of the tested taxon is positive.
    ...
    ## # A tibble: 10 × 26
    ##    taxon_id      d.wass `d.wass^2` `d.comp^2` d.comp location   size  shape   rho     pval p.ad.gpd N.exc gpd.shape perc.loc perc.size
    ##    <chr>          <dbl>      <dbl>      <dbl>  <dbl>    <dbl>  <dbl>  <dbl> <dbl>    <dbl>    <dbl> <dbl>     <dbl>    <dbl>     <dbl>
    ##  1 Intestinibac…  1.65       2.72       2.72   1.65     2.26  0.172  0.286  0.905 4.45e-16   0.296    250    0.0216     83.2      6.33
    ##  2 Streptococcus  0.604      0.365      0.366  0.605    0.329 0.0245 0.0127 0.997 1.66e-10   0.0842   250   -0.101      89.9      6.68
    ##  3 [Ruminococcu…  1.26       1.59       1.60   1.27     0.733 0.401  0.468  0.874 1.74e-10   0.841    250    0.0257     45.8     25.0 
    ##  4 Blautia        0.920      0.846      0.849  0.922    0.180 0.369  0.300  0.843 7.61e-10   0.0994   250   -0.0313     21.2     43.5 
    ##  5 Erysipelatoc…  0.828      0.686      0.690  0.831    0.217 0.0850 0.388  0.919 1.15e- 8   0.554    250   -0.129      31.4     12.3 
    ##  6 Enterococcus   1.55       2.39       2.39   1.55     2.09  0.0734 0.229  0.956 2.34e- 8   0.685    250    0.122      87.4      3.07
    ##  7 [Ruminococcu…  2.26       5.11       5.18   2.28     3.66  1.18   0.333  0.913 7.83e- 7   0.610    250   -0.0627     70.7     22.9 
    ##  8 [Clostridium…  1.97       3.89       3.92   1.98     1.68  1.40   0.842  0.823 3.16e- 6   0.670    250    0.0712     42.8     35.7 
    ##  9 Lactococcus    2.55       6.49       6.55   2.56     2.69  3.13   0.729  0.788 3.32e- 6   0.125    250   -0.0247     41.1     47.8 
    ## 10 Akkermansia    1.34       1.81       1.83   1.35     0.303 1.22   0.301  0.879 9.46e- 6   0.131    240   -0.0900     16.6     67.0 
    ## # ℹ 11 more variables: perc.shape <dbl>, decomp.error <dbl>, p.zero <dbl>, p.combined <dbl>, p.adj.nonzero <dbl>, p.adj.zero <dbl>,
    ## #   p.adj.combined <dbl>, n_nonzero_group1 <dbl>, n_nonzero_group2 <dbl>, n_group1 <int>, n_group2 <int>
...
### p-value refinement with permApprox
    ...
    ## # ℹ abbreviated names: ¹​n_testable_permapprox_unconstrained, ²​n_testable_permapprox_constrained, ³​n_zero_permapprox_unconstrained,
    ## #   ⁴​n_zero_permapprox_constrained
...
unconstrained or constrained permApprox resolves those zeros.
    ...
    ##  8 Streptococcus      Stre… waddR      waddR         0.365  1.66e-10 1.66e-10            0.000000748            0.000000748 nonzero_w…
    ##  9 Lactococcus        Lact… waddR      waddR         6.49   3.32e- 6 3.32e- 6            0.0000231              0.0000231   nonzero_w…
...
as the significance measure.
    ...
    ##    taxon_id     d.wass `d.wass^2` `d.comp^2` d.comp location    size  shape   rho     pval p.ad.gpd N.exc gpd.shape perc.loc perc.size
    ##    <chr>         <dbl>      <dbl>      <dbl>  <dbl>    <dbl>   <dbl>  <dbl> <dbl>    <dbl>    <dbl> <dbl>     <dbl>    <dbl>     <dbl>
    ##  1 Phascolarct…  2.59      6.69       6.79    2.61    6.01   0.0389  0.740  0.804 2.30e- 2  NA         NA   NA          88.5      0.57
    ##  2 Veillonella   0.219     0.0479     0.0477  0.218   0.0158 0.00315 0.0287 0.995 8.29e- 1  NA         NA   NA          33.1      6.62
    ##  3 Negativicoc…  1.39      1.92       1.92    1.39    1.79   0.0564  0.0769 0.974 2.50e- 2  NA         NA   NA          93.0      2.94
    ##  4 Dialister     0.319     0.101      0.106   0.325   0.0431 0.0484  0.0140 0.989 1.64e- 1  NA         NA   NA          40.9     45.8 
    ##  5 Megasphaera   1.80      3.22       3.50    1.87    1.31   1.91    0.274  0.938 2.69e- 1  NA         NA   NA          37.4     54.8 
    ##  6 Anaeroglobus  0.512     0.262      0.350   0.592   0.0871 0.117   0.146  0.977 1   e+ 0  NA         NA   NA          24.9     33.5 
    ##  7 Megamonas     1.89      3.57       3.60    1.90    3.50   0.0851  0.0170 0.742 9.31e- 2  NA         NA   NA          97.2      2.36
    ##  8 Streptococc…  0.604     0.365      0.366   0.605   0.329  0.0245  0.0127 0.997 1.66e-10   0.0842   250   -0.101      89.9      6.68
    ##  9 Lactococcus   2.55      6.49       6.55    2.56    2.69   3.13    0.729  0.788 3.32e- 6   0.125    250   -0.0247     41.1     47.8 
    ## 10 Gemella       0.310     0.0961     0.0960  0.310   0.0118 0.0124  0.0717 0.976 4.18e- 1  NA         NA   NA          12.3     12.9 
    ## # ℹ 106 more rows
    ## # ℹ 32 more variables: perc.shape <dbl>, decomp.error <dbl>, p.zero <dbl>, p.combined <dbl>, p.adj.nonzero <dbl>, p.adj.zero <dbl>,
    ## #   p.adj.combined <dbl>, n_nonzero_group1 <dbl>, n_nonzero_group2 <dbl>, n_group1 <int>, n_group2 <int>,
    ## #   zero_prevalence_estimate <dbl>, zero_prevalence_z <dbl>, taxon <chr>, p_permapprox_unconstrained <dbl>,
    ## #   p_permapprox_constrained <dbl>, p_combined_permapprox_unconstrained <dbl>, p_combined_permapprox_constrained <dbl>,
    ## #   p_adj_permapprox_unconstrained <dbl>, p_adj_permapprox_constrained <dbl>, p_adj_combined_permapprox_unconstrained <dbl>,
    ## #   p_adj_combined_permapprox_constrained <dbl>, fisher_statistic_permapprox_constrained <dbl>, method_used_unconstrained <chr>, …
...
two-stage waddR test.
    ...
    ##   taxon_id        d.wass `d.wass^2` `d.comp^2` d.comp location   size shape   rho     pval p.ad.gpd N.exc gpd.shape perc.loc perc.size
    ##   <chr>            <dbl>      <dbl>      <dbl>  <dbl>    <dbl>  <dbl> <dbl> <dbl>    <dbl>    <dbl> <dbl>     <dbl>    <dbl>     <dbl>
    ## 1 Intestinibacter  1.65       2.72       2.72   1.65     2.26  0.172  0.286 0.905 4.45e-16   0.296    250    0.0216     83.2      6.33
    ## 2 [Ruminococcus]…  1.26       1.59       1.60   1.27     0.733 0.401  0.468 0.874 1.74e-10   0.841    250    0.0257     45.8     25.0 
    ## 3 Blautia          0.920      0.846      0.849  0.922    0.180 0.369  0.300 0.843 7.61e-10   0.0994   250   -0.0313     21.2     43.5 
    ## 4 Enterococcus     1.55       2.39       2.39   1.55     2.09  0.0734 0.229 0.956 2.34e- 8   0.685    250    0.122      87.4      3.07
    ## # ℹ 31 more variables: perc.shape <dbl>, decomp.error <dbl>, p.zero <dbl>, p.combined <dbl>, p.adj.nonzero <dbl>, p.adj.zero <dbl>,
    ## #   p.adj.combined <dbl>, n_nonzero_group1 <dbl>, n_nonzero_group2 <dbl>, n_group1 <int>, n_group2 <int>,
    ## #   zero_prevalence_estimate <dbl>, zero_prevalence_z <dbl>, taxon <chr>, p_permapprox_unconstrained <dbl>,
    ## #   p_permapprox_constrained <dbl>, p_combined_permapprox_unconstrained <dbl>, p_combined_permapprox_constrained <dbl>,
    ## #   p_adj_permapprox_unconstrained <dbl>, p_adj_permapprox_constrained <dbl>, p_adj_combined_permapprox_unconstrained <dbl>,
...
separate zero stage.
    ...
    ##    taxon_id      d.wass `d.wass^2` `d.comp^2` d.comp location    size shape   rho     pval p.ad.gpd N.exc gpd.shape perc.loc perc.size
    ##    <chr>          <dbl>      <dbl>      <dbl>  <dbl>    <dbl>   <dbl> <dbl> <dbl>    <dbl>    <dbl> <dbl>     <dbl>    <dbl>     <dbl>
    ##  1 Lactococcus    1.84       3.40       3.42   1.85   0.917   2.27e+0 0.230 0.944 0          0.615    250 -0.105       26.8      66.5 
    ##  2 Enterococcus   1.88       3.53       3.53   1.88   2.99    8.32e-3 0.538 0.945 0          0.580    250 -0.141       84.5       0.24
    ##  3 Intestinibac…  1.92       3.67       3.68   1.92   2.63    4.50e-1 0.597 0.935 0          0.141    250 -0.0856      71.6      12.2 
    ##  4 Epulopiscium   0.818      0.669      0.680  0.825  0.00976 4.47e-1 0.223 0.702 0          0.182    130 -0.431        1.44     65.8 
    ##  5 Bacteroides    1.13       1.27       1.27   1.13   0.762   1.30e-2 0.493 0.960 0          0.548    250 -0.163       60.1       1.03
    ##  6 [Clostridium…  1.46       2.13       2.15   1.47   0.592   1.12e+0 0.431 0.947 5.96e-13   0.100    250 -0.0497      27.6      52.3 
    ##  7 Terrisporoba…  1.43       2.04       2.06   1.43   0.273   1.07e+0 0.710 0.771 2.41e- 7   0.122    250 -0.0157      13.3      52.2 
    ##  8 Blautia        0.933      0.871      0.874  0.935  0.158   3.76e-1 0.340 0.864 7.29e- 7   0.150    250 -0.0859      18.1      43.0 
    ##  9 Leuconostoc    0.979      0.959      0.966  0.983  0.0587  6.72e-1 0.235 0.708 2.00e- 6   0.339    250 -0.0191       6.07     69.6 
    ## 10 Streptococcus  0.746      0.556      0.560  0.748  0.409   2.17e-4 0.150 0.965 6.23e- 6   0.0578   150 -0.000769    73.1       0.04
    ## # ℹ 5 more variables: perc.shape <dbl>, decomp.error <dbl>, p.adj <dbl>, n_group1 <int>, n_group2 <int>
...
multiplicative replacement and CLR transformation.
    ...
    ##  8 Streptococcus        Stre… waddR      waddR         0.556  6.23e-6 6.23e-6            0.000000357               3.57e- 7 nonzero_w…
    ##  9 Lactococcus          Lact… waddR      waddR         3.40   0       0                  0                         3.58e-27 zero_both…
...
component plots.
    ...
    ##    taxon_id      d.wass `d.wass^2` `d.comp^2` d.comp location    size  shape   rho    pval p.ad.gpd N.exc gpd.shape perc.loc perc.size
    ##    <chr>          <dbl>      <dbl>      <dbl>  <dbl>    <dbl>   <dbl>  <dbl> <dbl>   <dbl>    <dbl> <dbl>     <dbl>    <dbl>     <dbl>
    ##  1 Phascolarcto…  0.418     0.174      0.173   0.416 0.00243  1.19e-1 0.0524 0.941 1.83e-1  NA         NA NA            1.4      68.4 
    ##  2 Veillonella    0.829     0.687      0.689   0.830 0.293    4.79e-3 0.391  0.969 8.83e-3   0.0984   220  0.0580      42.5       0.7 
    ##  3 Negativicocc…  0.382     0.146      0.147   0.384 0.000953 9.65e-2 0.0498 0.964 1.72e-1  NA         NA NA            0.65     65.5 
    ##  4 Dialister      0.190     0.0359     0.0368  0.192 0.00510  1.63e-2 0.0154 0.993 5.54e-1  NA         NA NA           13.9      44.2 
    ##  5 Megasphaera    0.431     0.185      0.187   0.432 0.00195  2.25e-5 0.185  0.832 2.39e-1  NA         NA NA            1.04      0.01
    ##  6 Anaeroglobus   0.261     0.0680     0.0727  0.270 0.00487  2.88e-2 0.0391 0.899 3.48e-1  NA         NA NA            6.69     39.6 
    ##  7 Megamonas      0.254     0.0647     0.0654  0.256 0.00608  3.10e-2 0.0283 0.872 6.41e-2  NA         NA NA            9.3      47.4 
    ##  8 Streptococcus  0.746     0.556      0.560   0.748 0.409    2.17e-4 0.150  0.965 6.23e-6   0.0578   150 -0.000769    73.1       0.04
    ##  9 Lactococcus    1.84      3.40       3.42    1.85  0.917    2.27e+0 0.230  0.944 0         0.615    250 -0.105       26.8      66.5 
    ## 10 Gemella        0.234     0.0550     0.0574  0.240 0.000383 1.68e-3 0.0553 0.992 7.11e-1  NA         NA NA            0.67      2.93
    ## # ℹ 107 more rows
    ## # ℹ 20 more variables: perc.shape <dbl>, decomp.error <dbl>, p.adj <dbl>, n_group1 <int>, n_group2 <int>, taxon <chr>,
    ## #   p_permapprox_unconstrained <dbl>, p_permapprox_constrained <dbl>, p_adj_permapprox_unconstrained <dbl>,
...
![](figures/09_diff_distribution/DD_volcano_two_stage_three_panels_complete_clr_x-1.png)<!-- -->
...
![](figures/09_diff_distribution/DD_volcano_two_stage_native_statistics-1.png)<!-- -->

![](figures/09_diff_distribution/DD_volcano_two_stage_one_stage_native-1.png)<!-- -->
...
one-stage Wasserstein test.
    ...
    ##   taxon_id          d.wass `d.wass^2` `d.comp^2` d.comp location    size shape   rho  pval p.ad.gpd N.exc gpd.shape perc.loc perc.size
    ##   <chr>              <dbl>      <dbl>      <dbl>  <dbl>    <dbl>   <dbl> <dbl> <dbl> <dbl>    <dbl> <dbl>     <dbl>    <dbl>     <dbl>
    ## 1 Intestinibacter     1.92       3.67       3.68   1.92    2.63  0.450   0.597 0.935     0    0.141   250   -0.0856     71.6     12.2 
    ## 2 Enterococcus        1.88       3.53       3.53   1.88    2.99  0.00832 0.538 0.945     0    0.580   250   -0.141      84.5      0.24
    ## 3 Lactococcus         1.84       3.40       3.42   1.85    0.917 2.27    0.230 0.944     0    0.615   250   -0.105      26.8     66.5 
    ## 4 [Ruminococcus]_g…   1.26       1.59       1.59   1.26    0.649 0.429   0.514 0.900   NaN    0.104   170   -0.202      40.8     27.0 
    ## # ℹ 18 more variables: perc.shape <dbl>, decomp.error <dbl>, p.adj <dbl>, n_group1 <int>, n_group2 <int>, taxon <chr>,
    ## #   p_permapprox_unconstrained <dbl>, p_permapprox_constrained <dbl>, p_adj_permapprox_unconstrained <dbl>,
    ## #   p_adj_permapprox_constrained <dbl>, method_used_unconstrained <chr>, method_used_constrained <chr>,
    ## #   shape_permapprox_unconstrained <dbl>, shape_permapprox_constrained <dbl>, scale_permapprox_unconstrained <dbl>,
