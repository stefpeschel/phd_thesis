...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../ch02_microbiome_data/figures/overview_characteristics.pdf}
...
Conditional on the sample-specific library size $m_k$, the count vector $x_k = (x_{k1}, \dots, x_{kp})^\top$ satisfies the constant-sum constraint
\begin{equation}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../ch02_microbiome_data/figures/overview_aggregation.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../ch02_microbiome_data/figures/overview_filtering.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../ch02_microbiome_data/figures/overview_normalization.pdf}
...
The assumptions underlying RLE and TMM were originally developed for gene-expression data and may be difficult to justify in microbiome studies when a substantial proportion of taxa changes jointly between groups or when compositional effects dominate the observed counts.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../ch02_microbiome_data/figures/overview_zero_replacement.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{../ch02_microbiome_data/figures/overview_transformation.pdf}
