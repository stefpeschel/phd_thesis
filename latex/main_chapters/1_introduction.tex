...
This leads to empirical $p$-values that lie on a coarse discrete grid, resulting in limited resolution in the tail of the distribution \citep{north2002more, phipson2010permutation}. 
...
$M$ & Number of possible undirected edges, $M = \frac{p(p-1)}{2}$ \\
