...
Notation used throughout the thesis is summarized in Appendix~\ref{app:notation}. Chapter-specific notation is introduced locally where needed. In particular, Chapter~\ref{ch:permapprox} contains a dedicated overview for permutation testing and GPD tail modeling.
